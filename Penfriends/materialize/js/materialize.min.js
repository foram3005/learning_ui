    ...
    var h = b,
        i = setInterval(function() {
            0 === g.parent().length && window.clearInterval(i), g.hasClass("panning") || (h -= 100), 0 >= h && (g.velocity({
                ...
                queue: !1,
                complete: function() {
                    $(this).remove(), "function" == typeof d && d()
                }
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
            ...
            return b = a.extend(c, b), this.each(function() {
                function b(a) {
                    a.parent().toggleClass("active"), a.parent().hasClass("active") ? a.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        ...
                        easing: "easeOutQuart",
                        queue: !1
                    }), e.not(a).parent().removeClass("active"), e.not(a).parent().children(".collapsible-body").stop(!0, !1).slideUp({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    })
                ...
                var e = (a(this), a(this).find(".collapsible-header"));
                c.accordion ? (e.each(function() {
                    a(this).click(function() {
                        b(a(this))
                    })
                }), b(e.filter(".active").first())) : e.each(function() {
                    a(this).hasClass("active") && d(a(this)), a(this).click(function() {
                        d(a(this))
                    })
                })
            })
    ...
    function(a) {
        a.fn.dropdown = function(b) {
            ...
            b = a.extend(c, b), this.each(function() {
                function c() {
                    var a = f.height();
                    b.constrain_width === !0 && f.css("width", e.outerWidth()), f.css(d(e[0]) ? {
                        display: "block",
                        position: "fixed",
                        height: 0,
                        top: e.position().top,
                ...
                var e = a(this),
                    f = a("#" + e.attr("data-activates"));
                if (f.parent().is(a("body")) || (f.detach(), a("body").append(f)), b.hover) e.on("mouseover", function() {
                    c()
                    ...
                    e.click(function(d) {
                        d.preventDefault(), d.stopPropagation(), c(), a(document).bind("click." + f.attr("id"), function(c) {
                            f.is(c.target) || e.is(c.target) || (f.velocity({
                                opacity: 0
                            }, {
                                duration: b.outDuration,
                                easing: "easeOutQuad",
                            ...
                            }), a(document).unbind("click." + f.attr("id")))
                        })
                    })
                }
            ...
            closeModal: function(b) {
                ...
                a("#lean-overlay").velocity({
                    ...
                    a(this).css({
                        ...
                        display: "none"
                    }), "function" == typeof b.complete && b.complete()
                })
            }
        }), a.fn.extend({
                ...
                function c(c) {
                    if (b > 992) {
                        var e = d.height(),
                            ...
                            m = (l - i) / (e + k),
                            n = -1 * g * m;
                        h > j && j + k > i && d.children("img").first().css("bottom", n + "px"), c && d.children("img").first().show()
                    } else d.children("img").show()
                }
                var d = a(this);
    ...
    function(a) {
        ...
        a.fn.tooltip = function(e) {
            ...
            return e = a.extend(g, e), this.each(function() {
                var e = a(this),
                    h = a("<div></div");
                h.addClass("material-tooltip").text(e.attr("data-tooltip")), h.appendTo(a("body"));
                var i = a("<div></div").addClass("backdrop");
                i.appendTo(h), i.css({
                    top: 0,
                    left: 0
                }), a(this).hover(function(a) {
                    a.stopPropagation(), b = 0, d = setInterval(function() {
                        if (b += 50, b >= g.delay && 0 == c) {
                            c = !0, h.css({
                                display: "block",
                                left: "0px",
                                top: "0px"
                            ...
                            var a = e.outerWidth(),
                                ...
                                o = 8;
                            "top" === j ? (h.css({
                                top: e.offset().top - k - f,
                                left: e.offset().left + a / 2 - l / 2
                            }), m = "-10px", i.css({
                                borderRadius: "14px 14px 0 0",
                                transformOrigin: "50% 90%",
                                marginTop: k,
                                marginLeft: l / 2 - i.width() / 2
                            })) : "left" === j ? (h.css({
                                top: e.offset().top + d / 2 - k / 2,
                                left: e.offset().left - l - f
                            }), n = "-10px", i.css({
                                width: "14px",
                                height: "14px",
                                ...
                                top: e.offset().top + e.outerHeight() + f,
                                left: e.offset().left + a / 2 - l / 2
                            }), console.log(e.offset().left), console.log(a / 2), console.log(l / 2), m = "+10px", i.css({
                                marginLeft: l / 2 - i.width() / 2
                            })), o = l / 8, 8 > o && (o = 8), ("right" === j || "left" === j) && (o = l / 10, 6 > o && (o = 6)), h.velocity({
                                opacity: 1,
                                marginTop: m,
                                marginLeft: n
                            }, {
                    ...
                    clearInterval(d), b = 0, h.velocity({
                        opacity: 0,
                        marginTop: 0,
                        marginLeft: 0
                    }, {
                        ...
                        queue: !1,
                        complete: function() {
                            i.css("display", "none"), h.css("display", "none"), c = !1
                        }
                    })
                })
            })
    ...
    function(a) {
            ...
            h = {
                ...
                show: function(a) {
                    ...
                    var f = d(b),
                        g = a.pageY - f.top,
                        h = a.pageX - f.left,
                        i = "scale(" + b.clientWidth / 100 * 22 + ")";
                    "touches" in a && (g = a.touches[0].pageY - f.top, h = a.touches[0].pageX - f.left), c.setAttribute("data-hold", Date.now()), c.setAttribute("data-scale", i), c.setAttribute("data-x", h), c.setAttribute("data-y", g);
                    var j = {
                        top: g + "px",
                        left: h + "px"
                    };
                    c.className = c.className + " waves-notransition", c.setAttribute("style", e(j)), c.className = c.className.replace("waves-notransition", ""), j["-webkit-transform"] = i, j["-moz-transform"] = i, j["-ms-transform"] = i, j["-o-transform"] = i, j.transform = i, j.opacity = "1", j["-webkit-transition-duration"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["-moz-transition-duration"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["-o-transition-duration"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["transition-duration"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["-webkit-transition-timing-function"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["-moz-transition-timing-function"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["-o-transition-timing-function"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", j["transition-timing-function"] = "cubic-bezier(0.215, 0.610, 0.355, 1.000)", c.setAttribute("style", e(j))
                },
                hide: function() {
                    for (var a = this, b = (1.4 * a.clientWidth, null), c = a.children.length, d = 0; c > d; d++) - 1 === a.children[d].className.indexOf("waves-ripple") || (b = a.children[d]);
                    if (!b) return !1;
                    ...
                    0 > k && (k = 0), setTimeout(function() {
                        ...
                        b.setAttribute("style", e(c)), setTimeout(function() {
                            try {
                                a.removeChild(b)
                            } catch (c) {
                                return !1
                ...
                wrapInput: function(a) {
                    for (var b = 0; b < a.length; b++) {
                        ...
                        if ("input" === c.tagName.toLowerCase()) {
                            var d = c.parentNode;
                            if ("i" === d.tagName.toLowerCase() && -1 !== d.className.indexOf("waves-effect")) return !1;
        ...
        f.displayEffect = function(b) {
            b = b || {}, "duration" in b && (h.duration = b.duration), h.wrapInput(g(".waves-effect")), Array.prototype.forEach.call(g(".waves-effect"), function(b) {
                "ontouchstart" in a && (b.addEventListener("mouseup", h.hide, !1), b.addEventListener("touchstart", h.show, !1), b.addEventListener("mouseleave", h.hide, !1), b.addEventListener("touchend", h.hide, !1), b.addEventListener("touchcancel", h.hide, !1)), b.addEventListener("mousedown", h.show, !1), b.addEventListener("mouseup", h.hide, !1), b.addEventListener("mouseleave", h.hide, !1)
            })
        }, a.Waves = f, $(document).ready(function() {
            f.displayEffect()
        })
    }(window),
    function(a) {
        ...
        function c(a) {
            for (var c = g.length; c--;)
                if (a.keyCode === g[c]) return void b(a)
        }
        ...
        function e() {
            window.addEventListener && window.addEventListener("DOMMouseScroll", d, !1), window.onmousewheel = document.onmousewheel = d, document.onkeydown = c
        }
        ...
        var g = [32, 33, 34, 35, 36, 37, 38, 39, 40];
        a.fn.sideNav = function(b) {
            ...
            b = a.extend(c, b), a(this).each(function() {
                ...
                var d = a(this),
                    ...
                    h = g.width();
                "left" != b.edge && g.addClass("right-aligned"), g.hasClass("fixed") && a(window).resize(function() {
                    a(window).width() > 1200 && g.attr("style") && g.removeAttr("style")
                });
                var i = !1,
                    j = !1;
                a("nothing").hammer({
                    ...
                    if ("touch" === d.gesture.pointerType) {
                        {
                            var e = d.gesture.direction,
                                f = d.gesture.center.x;
                            d.gesture.center.y
                        }
                        if (i) {
                            if (!a("#sidenav-overlay").length) {
                                ...
                                k.css("opacity", 0).click(function() {
                                    i = !1, j = !1, c(), "left" === b.edge ? g.velocity({
                                        left: -1 * h
                                    }, {
                                        duration: 300,
                                        queue: !1,
                            ...
                            f > h ? f = h : 0 > f ? f = 0 : h / 2 > f ? j = !1 : f >= h / 2 && (j = !0), "left" === b.edge ? g.velocity({
                                left: -1 * h + f
                            }, {
                                duration: 50,
                                queue: !1,
                        ...
                        } else j ? d.gesture.center.x > h - b.activationWidth && 2 === e && (i = !0) : d.gesture.center.x < b.activationWidth && 4 === e && (i = !0)
                    }
                }).bind("panend", function(b) {
                    "touch" === b.gesture.pointerType && (i = !1, j ? (g.velocity({
                        left: 0
                    }, {
                        duration: 300,
                        queue: !1,
                    ...
                    if (g.hasClass("active")) j = !1, i = !1, c();
                    else {
                        e(), "left" === b.edge ? g.velocity({
                            left: 0
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function(a) {
        a(document).ready(function() {
            var b = "input[type=text], input[type=password], input[type=email], textarea";
            if (a(b).each(function() {
                    ...
                    console.log(a(this).is(":valid")), 0 === a(this).val().length ? (a(this).siblings("label, i").removeClass("active"), a(this).hasClass("validate") && (a(this).removeClass("valid"), a(this).removeClass("invalid"))) : a(this).hasClass("validate") && (a(this).is(":valid") ? (a(this).removeClass("invalid"), a(this).addClass("valid")) : (a(this).removeClass("valid"), a(this).addClass("invalid")))
                }), 0 === a(".hiddendiv").length) {
                var c = a('<div class="hiddendiv common"></div>'),
                    d = null;
                a("body").append(c)
            }
            var e = (a(".hiddendiv"), ".materialize-textarea");
            ...
            a(document).on("mousedown", h, function(b) {
                ...
                a(this).each(function() {
                    if ($select = a(this), !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                        var b = i(),
                            c = a('<div class="select-wrapper"></div>'),
                            d = a('<ul id="select-options-' + b + '" class="dropdown-content select-dropdown"></ul>'),
                            e = $select.children("option");
                        if (void 0 !== $select.find("option:selected")) var f = $select.find("option:selected");
                        else var f = d.first();
                        e.each(function() {
                            d.append(a('<li class="' + (a(this).is(":disabled") ? "disabled" : "") + '"><span>' + a(this).html() + "</span></li>"))
                        }), d.find("li").each(function(b) {
                            var c = $select;
                            a(this).click(function() {
                                a(this).hasClass("disabled") || (c.find("option").eq(b).prop("selected", !0), "function" == typeof c.context.onchange && c[0].onchange(), c.prev("span.select-dropdown").html(a(this).text()))
                            })
                        }), $select.wrap(c);
                        var g = a('<span class="select-dropdown ' + ($select.is(":disabled") ? "disabled" : "") + '" data-activates="select-options-' + b + '">' + f.html() + "</span>");
                        $select.before(g), a("body").append(d), $select.is(":disabled") || g.dropdown({
                            hover: !1
    ...
    function(a) {
        a.fn.slider = function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                if (-1 != i && (e = h.eq(i)), f.height(b.height + 40), g.height(b.height), h.find(".caption").each(function() {
                        c(a(this), 0)
                    }), b.indicators) {
        ...
        a(document).ready(function() {
            a(document).on("click.card", ".card", function(b) {
                a(this).find(".card-reveal").length && (a(b.target).is(a(".card-reveal .card-title")) || a(b.target).is(a(".card-reveal .card-title i")) ? a(this).find(".card-reveal").velocity({
                    ...
                    queue: !1,
                    easing: "easeOutQuad"
                }) : (a(b.target).is(a(".card .card-title")) || a(b.target).is(a(".card .card-title i")) || a(b.target).is(a(".card .card-image"))) && a(this).find(".card-reveal").velocity({
                    translateY: "-100%"
                }, {
                    duration: 300,
                    queue: !1,
